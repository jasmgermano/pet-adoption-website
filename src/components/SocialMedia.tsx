...
export function SocialMedia () {
    return (
        <div>
            <div id="contato" className="relative h-auto overflow-hidden bg-custom-red top-0 py-32 lg:h-[1000px] xl:px-44">
                ...
                <div className="absolute top-36 -left-14 z-0">
                    <Image src={Bone} alt="Osso" className="w-28 lg:w-52" />
                </div>
                <div className="absolute top-1/3 -right-7 z-0 lg:top-36">
                    <Image src={Paw} alt="Pata" className="w-20 -rotate-[70deg] lg:w-44" />
                </div>
                <div className="absolute bottom-60 -right-14 z-0">
                    <Image src={Bone} alt="Osso" className="w-28 -rotate-90 lg:w-44" />
                </div>
                <div className="absolute bottom-10 -left-10 z-0">
                    <Image src={Paw} alt="Pata" className="w-28 lg:w-52" />
                </div>

                <div className="h-[80%] z-10 flex justify-center lg:mt-10">
                    <Container>
                        <div className="z-10 lg:flex lg:items-center lg:gap-5">
                            <div className='mb-10 lg:order-2 lg:mb-0'>
