...
export function WhoWeAre() {
  return (
    <div>
      <div
        id="quemsomos"
        className="relative h-[850px] overflow-hidden bg-custom-cyan top-0 md:h-[1000px]"
      >
          ...
          <div className="h-full flex flex-col justify-end items-center z-10 mb-7 lg:flex-row lg:mb-0">
            <div className="w-full lg:order-2 lg:w-2/3 lg:pl-24">
              ...
              <p className="text-white text-lg font-light mt-10 text-justify md:text-2xl lg:text-3xl lg:mt-20">
                Somos o &apos;Adotar é LegAU&apos;, uma iniciativa da Prefeitura
                de Alfenas e da Unifal. Nosso foco é promover a adoção
                responsável e humanizar o tratamento de animais de rua, educando
                a comunidade sobre cuidado ético e compassivo para criar uma
