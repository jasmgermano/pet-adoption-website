...
export function Header ({titleLine1, titleLine2, subtitleColor, buttonColor, image}: HeaderProps) {
    return (
        <Container>
            <div id="home" className="flex flex-col h-[850px] items-center w-full justify-center lg:h-screen lg:flex-row lg:-mt-14">
                ...
                <div className="mt-4 flex flex-col items-center lg:items-start">
                    ...
                    <button className={`rounded-full ${buttonColor} text-white uppercase font-bold w-32 h-10 mt-5 lg:w-56 lg:h-16 lg:text-2xl`}>
                        <a href="https://wa.me/553584137314/?text=Ol%C3%A1%2C+tenho+interesse+em+doar+para+o+projeto%21" target="_blank">Quero doar!</a>
